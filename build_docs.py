...
def header(active='docs'):
  ...
  <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
    ...
    <details class="md:hidden relative"><summary class="list-none cursor-pointer p-2 -mr-2 select-none" aria-label="Open menu">{HAMBURGER}</summary><div class="absolute right-0 mt-2 bg-white border border-slate-200 rounded shadow-lg py-2 w-52 z-20 flex flex-col text-sm">
      {' '.join(mobile)}
      <a href="https://download.muros.org/" class="nav-link hover:text-slate-900 px-4 py-2 hover:bg-slate-100">Download</a>
      <a href="https://download.muros.org/" class="px-4 py-2 mt-1 mx-3 bg-amber-400 hover:bg-amber-500 text-slate-900 font-semibold rounded text-center">Install</a>
      <a href="https://github.com/murosorg/muros" class="inline-flex items-center justify-center gap-1.5 px-4 py-2 mt-1 mx-3 github-header inline-flex items-center justify-center"><svg width="30" height="30" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" class="-ml-0.5"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.01 8.01 0 0016 8c0-4.42-3.58-8-8-8z"/></svg></a>
      {THEME_TOGGLE_MOBILE}
    </div></details>
  </div>
</header>'''
...
FOOTER = '''<footer class="border-t border-slate-200 bg-slate-100 band-dark">
  <div class="max-w-6xl mx-auto px-6 py-6 text-sm text-slate-900 flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between">
    <div>MurOS &middot; BSD-2-Clause</div>
    ...
    <div class="flex items-center gap-5">
      ...
      <a href="https://download.muros.org/" class="hover:text-amber-700">Install</a>
...
<meta name="theme-color" content="#1f2638">
<title>{title}</title>
