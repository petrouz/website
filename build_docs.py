...
def header(active='docs'):
    template = (pathlib.Path(__file__).parent / "partials/header.html").read_text()
    return template.replace("href=\"https://muros.org/docs/quickstart.html\" class=\"nav-link hover:text-slate-900\"", "href=\"https://muros.org/docs/quickstart.html\" class=\"nav-link hover:text-slate-900 active\"")


FOOTER = (pathlib.Path(__file__).parent / "partials/footer.html").read_text()
